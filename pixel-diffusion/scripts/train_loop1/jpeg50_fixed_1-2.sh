...
# Replace with your own; path to annotated dataset e.g. ${outdir}/ambient-syn-runs/cifar/restore_omni/fixed_sigma/jpeg50/sigma_1.2/s-max-4/00000-npy-uncond-ddpmpp-edm-gpus8-batch512-fp32-8DVvm/rho_ambient_8/seeds0-49999
dataset_path=
s_max=4
dp=1.0
weight_decay=0.0
