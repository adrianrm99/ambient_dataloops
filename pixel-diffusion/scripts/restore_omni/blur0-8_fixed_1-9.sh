...
annotated_dataset_path=./outputs/annotated_cifar10/fixed_sigma/blur0-8/sigma_1.9
# Replace with your own e.g. fixed_sigma/blur0-8/sigma_1.9/s-max-4/00000-npy-uncond-ddpmpp-edm-gpus8-batch512-fp32-8DVvm
ckpt_dir=
dp=1.0
weight_decay=0.0
sigma_tn=$(echo "$dataset_path" | sed -n 's|.*sigma_\([0-9.]*\).*|\1|p')
rho_ambient=8
# Replace with your own i.e. iters_list=("018063")
iters_list=
seeds=0-49999
#seeds=50000-99999
#seeds=100000-149999
