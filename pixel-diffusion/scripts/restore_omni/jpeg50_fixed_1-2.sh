...
annotated_dataset_path=./outputs/annotated_cifar10/fixed_sigma/jpeg50/sigma_1.2
# Replace with your own e.g. fixed_sigma/jpeg50/sigma_1.2/s-max-4/00000-npy-uncond-ddpmpp-edm-gpus8-batch512-fp32-1nGEw
ckpt_dir=
dp=1.0
weight_decay=0.0
