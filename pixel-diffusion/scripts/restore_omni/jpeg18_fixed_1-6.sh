...
annotated_dataset_path=./outputs/annotated_cifar10/fixed_sigma/jpeg18/sigma_1.6
# Replace with your own e.g. fixed_sigma/jpeg18/sigma_1.6/s-max-4/00000-npy-uncond-ddpmpp-edm-gpus8-batch512-fp32-7MxDG
ckpt_dir=
dp=1.0
weight_decay=0.0
