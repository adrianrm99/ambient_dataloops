...
iters_list=("010035" "011039" "012042" "013046" "014049" "015053" "016056" "017060" "018063" "019067" "020070")
...
for iter_num in "${iters_list[@]}"; do
  ...
  eval_path=./outputs/ambient-syn-evals/cifar/train_omni/${ckpt_name}/seeds${seeds}
